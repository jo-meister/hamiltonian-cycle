...
# Generate mapped dat file input.
file_location = 'datafiles/hc_to_tsp_map.dat'
with open('mappedfiles/vertexcover_to_hc_map.dat', 'w') as f:
    f.write('Vertex Cover -> Hamiltonian Cycle\n')
    for i in range(len(adj_matrix)):
        for j in range(len(adj_matrix)):
            if adj_matrix[i][j] == 1:
                ...
                f.write('\n')
    f.write('$\n')
    f.write('This file was generated by running:\n')
    f.write('python3 vertexcover_to_hc.py datafiles/vertex_cover.dat')
